...
export interface ButtonProps
  ...
  /**
   * If true, button will take up the full width of its container
   */
  fullWidth?: boolean;
}
...
function Button({
  ...
  return (
    ...
    >
      {isLoading ? (
        <>
          <LuLoader className="size-4 animate-spin" aria-hidden="true" />
        ...
        <>
          ...
          {children}
          {RightIcon && <RightIcon className="size-4" aria-hidden="true" />}
        </>
      )}
    </Comp>
  );
